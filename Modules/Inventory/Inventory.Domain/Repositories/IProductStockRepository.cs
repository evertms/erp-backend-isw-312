...
public interface IProductStockRepository
{
    ...
    Task<List<ProductStock>> GetStockAsync(string companyCen, int? productId = null, int? warehouseId = null, CancellationToken cancellationToken = default);
    Task<List<ProductStock>> GetAllActiveProductsStock(string companyCen, CancellationToken cancellationToken = default);
